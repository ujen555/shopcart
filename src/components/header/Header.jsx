...
const Header = () => {
  ...
  return (
    <header>
      <div className="coupounHeader">
        <div className="coupounHeader__phone">
          <a href="tel:9861665558">9861665558</a>
        </div>
       
        <div className="coupounHeader__notice">
          SEE students passed sale
          <Link to="/#product" className="bold"> Shop Now</Link>
        </div>
        <select
          className="coupounHeader__langSelect"
          name="language"
          id="language"
        >
      ...
      <label for="checkbox_toggle" className="hamburger"><RxHamburgerMenu></RxHamburgerMenu></label>
